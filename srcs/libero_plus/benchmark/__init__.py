...
# from libero.libero.benchmark.libero_suite_task_map_spatial import libero_task_map
from libero.libero.benchmark.libero_suite_task_map_spatial_sparse_n3 import libero_task_map
...
# task_num = [726, 794, 817, 812, 0]
task_num = [60, 60, 60, 60, 0]
